...
image::enquetePAC2017.png[width=60%]
...
_Nos entreprises IT existent grâce à l'Open Source_

(de manière directe ou indirecte)

image:open-source-500.jpeg[width=50%] +
@like_gudim
...
image:koson-qrcode.png[] image:live.gif[width=50%]
